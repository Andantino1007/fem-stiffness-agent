...
def validate_sample_artifacts(
    ...
    source = payload.get("reference_matrix_source", payload.get("reference_matrix_source"))
    ...
    matrix_relative = payload.get("reference_matrix", payload.get("reference_matrix"))
