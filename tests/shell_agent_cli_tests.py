...
from shell_agent.verification import evaluate_sample, prepare_adapter, run_verification
...
from shell_agent.matrix_validation import compare_matrices, read_square_matrix
from shell_agent.project_config import load_project_config
...
class ShellAgentCliTests(unittest.TestCase):
    ...
    def test_accepts_non_24_project_configuration(self) -> None:
        payload = {
            ...
            "primary_sample": "data/cps4/meta/sample.json",
            "adapter": {
                "kind": "command",
    ...
    def test_command_adapter_generates_generic_non_24_report(self) -> None:
        payload = {
            ...
            "primary_sample": "data/test2/meta/sample.json",
            "adapter": {
                "kind": "command",
