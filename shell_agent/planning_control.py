...
MEMORY_PATH = ROOT / "workflow" / "experiment-memory.json"
PLANNING_STATE_PATH = ROOT / "workflow" / "planning-state.json"
ARCHIVE_ROOT = ROOT / "workflow" / "archive"
PLANS_ROOT = ROOT / "workflow" / "plans"
LATEST_REPORT_PATH = ROOT / "docs" / "verification" / "agent-latest.md"
PROGRESS_PATH = ROOT / "docs" / "PROJECT_PROGRESS.md"
...
def replan() -> tuple[int, Path | None]:
    ...
    from agent_openai_client import load_openai_config
    from agents import (
